    ...
    <div className="space-y-4">
      ...
      <dl className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <div className="rounded-control border border-line-subtle bg-base p-4">
          <dt className="label text-fg-subtle">{t('u.the-baseline')}</dt>
        ...
        <div className="rounded-control border border-line-subtle bg-base p-4">
          <dt className="label text-fg-subtle">{t('u.the-score')}</dt>
      ...
      <ul className="space-y-2 text-sm text-fg-muted">
        <li>
          <span className="text-fg">{t('u.clamped-to-0-100')}</span> The engine stores the delta it actually
        ...
        <li>
          <span className="text-fg">{t('u.being-attacked-is-not-a-mark-against')}</span> Having a threat
        ...
        <li>
          <span className="text-fg">{t('u.reporting-lowers-it')}</span> The person who reports is the sensor,
