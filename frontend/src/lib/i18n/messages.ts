...
const az: Record<MessageKey, string> = {
  ...
  'nav.training.hint': 'Təlim məzmununu yaz, yoxla və versiyala',
  'nav.sandbox': 'Sandbox',
  ...
  'nav.remediation': 'Aradan qaldırma',
  ...
  'action.export': 'İxrac et',
  'action.viewAll': 'Hamısına bax',

  'state.loading': 'Yüklənir',
  'state.empty': 'Hələ heç nə yoxdur',
  'state.error': 'Xəta baş verdi',
  'state.noData': 'Ölçülməyib',
  ...
  'page.remediation.title': 'Aradan qaldırma',
  'page.incident-risks.title': 'İnsident riskləri',
  'page.policy.title': 'Siyasət uyğunsuzluğu və məruzqalma',
