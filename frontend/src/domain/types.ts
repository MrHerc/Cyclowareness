...
export const STAGES = [
  {
    ...
    key: 'ingest',
    label: 'Intake',
    hint: 'Human sensor, feed, API',
    owner: 'Platform',
    labelKey: 's.ingest.label',
    hintKey: 's.ingest.hint',
    ownerKey: 's.ingest.owner',
  },
  {
    n: 2,
    key: 'analyze',
    label: 'Analysis',
    hint: 'Sandbox verdict and IOCs',
    owner: 'Sandbox',
    labelKey: 's.analyze.label',
    hintKey: 's.analyze.hint',
    ownerKey: 's.analyze.owner',
  },
  {
    n: 3,
    key: 'convert',
    label: 'Conversion',
    hint: 'Threat becomes safe training',
    owner: 'AI',
    labelKey: 's.convert.label',
    hintKey: 's.convert.hint',
    ownerKey: 's.convert.owner',
  },
  {
    n: 4,
    key: 'target',
    label: 'Targeting',
    hint: 'The people actually at risk',
    owner: 'Risk engine',
    labelKey: 's.target.label',
    hintKey: 's.target.hint',
    ownerKey: 's.target.owner',
  },
  {
    n: 5,
    key: 'train',
    label: 'Training',
    hint: 'Delivery and completion',
    owner: 'Employee',
    labelKey: 's.train.label',
    hintKey: 's.train.hint',
    ownerKey: 's.train.owner',
  },
  {
    n: 6,
    key: 'measure',
    label: 'Measurement',
    hint: 'Behaviour, not attendance',
    owner: 'Platform',
    labelKey: 's.measure.label',
    hintKey: 's.measure.hint',
    ownerKey: 's.measure.owner',
  },
  {
    n: 7,
    key: 'feedback',
    label: 'Feedback',
    hint: 'Evidence updates the model',
    owner: 'Risk engine',
    labelKey: 's.feedback.label',
    hintKey: 's.feedback.hint',
    ownerKey: 's.feedback.owner',
  },
] as const
